...
const PainSection = () => {
  ...
  return (
    <ScrollView className="flex-1 p-4">
      ...
      <View>
          <Text className="text-lg font-bold mt-4 mb-2 text-blue-900 ">Select Intensity (Level 0 - 5)</Text>

          <View className="items-center">
            <View className="flex-row justify-evenly w-full">
              {[0, 1, 2, 3, 4, 5].map((num) => (
                <Text key={num} className="text-xs text-gray-500">
                  {num}
                </Text>
              ))}
            </View>
        ...
        <View>
          <TouchableOpacity className="mt-4 bg-[#00B8DF] p-3 rounded" onPress={() => console.log('Next pressed')}>
